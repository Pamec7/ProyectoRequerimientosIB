...
public class ArchReservas {
    ...
    public static ArrayList<Reserva> cargarReservasDesdeArchivo(ArrayList<Alojamiento> alojamientos) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(ARCHIVO_RESERVAS))) {
            ...
            while ((linea = reader.readLine()) != null) {
                ...
                Alojamiento alojamiento = buscarAlojamiento(alojamientos, Idalojamiento);
                if(alojamiento!= null){
                    ...
                    Double monto = Double.valueOf(datos[4]);
                    Reserva reserva = new Reserva(Idalojamiento, nombreHuesped,fechaInicio,fechaFin, new Pago(monto) );
    ...
    private static Alojamiento buscarAlojamiento(ArrayList<Alojamiento> alojamientos, int numeroAl) {
